...
function GlobalIndices_To_StateIndex(x::Int64,y::Int64,z::Int64,px::Int64,py::Int64,pz::Int64,species_index::Int64,PhaseSpace::PhaseSpaceStruct)
    ...
    px_num = PhaseSpace.Momentum.px_num_list[species_index]
    py_num = PhaseSpace.Momentum.py_num_list[species_index]
    pz_num = PhaseSpace.Momentum.pz_num_list[species_index]
    ...
    return off_momentum + off_space + off_name
...
function Location_Species_To_StateVector(StateVector::Vector{F},PhaseSpace::PhaseSpaceStruct;x_idx::Int64=1,y_idx::Int64=1,z_idx::Int64=1,species_index::Int64=0) where F<:AbstractFloat
    ...
    start_idx = n_momentum*off_space+1+off_name
    end_idx   = n_momentum*off_space+1+off_name+px_num*py_num*pz_num

    start_idx = 1+off_name+off_space*n_momentum
    end_idx = off_name+(off_space+1)*n_momentum
